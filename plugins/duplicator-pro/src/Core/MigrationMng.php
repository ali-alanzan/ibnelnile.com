...
class MigrationMng
{
    ...
    public static function init()
    {
        ...
        add_action(self::HOOK_FIRST_LOGIN_AFTER_INSTALL, function (MigrateData $migrationData) {
            DUP_PRO_Plugin_Upgrade::updateDatabase();
        });
        add_action(self::HOOK_FIRST_LOGIN_AFTER_INSTALL, function (MigrateData $migrationData) {
        ...
        add_action(self::HOOK_FIRST_LOGIN_AFTER_INSTALL, array(__CLASS__, 'updateUsageStatistics'));
        add_action(self::HOOK_FIRST_LOGIN_AFTER_INSTALL, array(__CLASS__, 'sendInstallerStatistics'));
     ...
     * @return void
     */
    public static function updateUsageStatistics(MigrateData $migrationData)
    {
        if ($migrationData->recoveryMode) {
            PluginData::getInstance()->addRecoveryCount();
        }
    }
     ...
     * @return void
     */
    public static function sendInstallerStatistics(MigrateData $migrationData)
    {
