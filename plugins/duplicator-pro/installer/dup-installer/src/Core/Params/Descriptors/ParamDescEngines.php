...
final class ParamDescEngines implements DescriptorInterface
{
    ...
    public static function updateParamsAfterOverwrite($params)
    {
        if (
            ...
            InstState::isRecoveryMode($params[PrmMng::PARAM_INST_TYPE]->getValue())
        ) {
            $params[PrmMng::PARAM_ARCHIVE_ACTION]->setValue(DUP_PRO_Extraction::ACTION_REMOVE_WP_FILES);
        }

        if (InstState::dbDoNothing() || InstState::isRestoreBackup($params[PrmMng::PARAM_INST_TYPE]->getValue())) {
