...
export default {
  ...
  methods: {
    ...
    processResponse() {
      ...
      let processedData = [];
      let totalVisits = data.reports.visits_count.value;

      for (let [index, dataPoint] of data.reports[dataType].entries()) {
        dataPoint.name = dataPoint.label;
        dataPoint.value = dataPoint.nb_visits;
        dataPoint.value_comp = 0;
        ...
        if (comparisonData) {
          ...
          dataPoint.value_comp = compValue;
          ...
          <div class="uip-background-default uip-boder uip-shadow uip-border-rounder uip-overflow-hidden uip-text-normal">
            <div class="uip-background-default">
              ...
              <div class="uip-padding-xs uip-flex uip-flex-column uip-row-gap-xxs">
                ...
                <div class="uip-flex uip-flex-row uip-gap-xxs uip-flex-between uip-w-125">
                  <div class="uip-text-bold uip-text-orange">${country.value_comp + ' ' + this.strings.visits}</div>
