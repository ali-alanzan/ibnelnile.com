<div class="tpa-dashboard-info">
    <div class="tpa-dashboard-info-links">
        <p>
            ...
            <span class="logo">
                <a href="https://coolplugins.net/?utm_source=tpa_plugin&utm_medium=inside&utm_campaign=author_page&utm_content=dashboard_footer" target="_blank">
        ...
        <a href="https://coolplugins.net/support/?utm_source=tpa_plugin&utm_medium=inside&utm_campaign=support&utm_content=dashboard_footer" target="_blank"><?php _e('Support', $text_domain); ?></a> |
        <a href="https://docs.coolplugins.net/docs/automatic-translate-addon-for-translatepress-pro/?utm_source=tpa_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard_footer" target="_blank"><?php _e('Docs', $text_domain); ?></a>
